...
public partial class PlatformerController2D : KinematicBody2D
{
	[Signal]
	...
	public override void _PhysicsProcess(float delta)
	{
		try
		{
			...
			MoveAndSlide(Velocity, new Vector2(0.0f, -1.0f));
			if (IsFeetOnGround())
			{
	...
	private void DoubleJump()
	{
		...
		_jumpsLeft -= 1;
		EmitSignal(nameof(jumped), false);
	}
